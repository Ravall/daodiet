...
// Do not delete these lines
	...
	if ( post_password_required() ) { ?>
		<p class="nocomments">Эта запись защищена паролем. Введите пароль, чтобы добавить комментарий.</p>
	<?php
		return;
	}
?>
...
<?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php comments_number('Нет Ответов', 'Один Ответ', '% Ответа(-ов)' );?> к &#8220;<?php the_title(); ?>&#8221;</h3>
...
<h3><?php comment_form_title( 'Оставить Ответ', 'Оставить Ответ на %s' ); ?></h3>
